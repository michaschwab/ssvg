...
export const RELEVANT_ATTRS: {[type in VdomNodeType]: string[]} = {
    'svg': ['fill', 'opacity', 'fill-opacity', 'stroke', 'stroke-opacity',
        'stroke-width', 'font-size', 'font', 'font-family', 'text-anchor'],
    'g': ['fill', 'opacity', 'fill-opacity', 'stroke', 'stroke-opacity',
        'stroke-width', 'font-size', 'font', 'font-family', 'text-anchor'],
    'rect': ['fill', 'opacity', 'fill-opacity', 'stroke', 'stroke-opacity',
        'stroke-width', 'x', 'y', 'width', 'height'],
    'circle': ['fill', 'opacity', 'fill-opacity', 'stroke', 'stroke-opacity',
        'stroke-width', 'cx', 'cy', 'r'],
    'path': ['fill', 'opacity', 'fill-opacity', 'stroke', 'stroke-opacity',
        'stroke-width', 'd'],
    'title': [],
    'tspan': ['dx', 'dy'],
    ...
    'clippath': ['id', 'fill', 'opacity', 'fill-opacity', 'stroke', 'stroke-opacity',
        'stroke-width'],
    'line': ['opacity', 'stroke', 'stroke-opacity', 'stroke-width', 'x1', 'x2', 'y1',
        'y2'],
